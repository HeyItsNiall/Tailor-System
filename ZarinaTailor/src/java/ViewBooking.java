...
public class ViewBooking extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        out.println("<a href='booking.html'>Add New Booking</a>");
        out.println("<a href='main.html'>Back to Main Page</a>");
        out.println("<h1>Booking List</h1>");
        
        List<Booking> list=BookingDao.getAllBooking();
        
        out.print("<table border='1' width='100%'");
        out.print("<tr><th>Id</th><th>Name</th><th>Email</th><th>Services</th><th>Description</th>"
                + "<th>Edit</th><th>Delete</th></tr>");
        for(Booking e:list){
            out.print("<tr><td>"+e.getId()+"</td><td>"+e.getName()+"</td><td>"
                    +e.getEmail()+"</td><td>"+e.getServices()+"</td><td>"+e.getDescription()+"</td><td><a href='EditBooking?id="
